...
// есть 8 квартир. У каждой комнаты есть длина, ширина, высота, номер этажа, угловая квартира - булевая переменная.
//посчитать привлекательность квартиры. Считается пощадь квартиры, если высота<5% от площади, индекс привлекательности
//падает на 10%. Если квартира угловая, на 20% от начального падает. Если ниже, чем на 2ом или выше, чем на
//5ом индекс привлекательности падает на 15%. За базовый индекс привлеательности взять площадь
//квартиры. Вывести наиболее привлекательную квартиру. Все сделать в объектах и написать максимальное количество
//методов, которые описывают все про эту квартиру.
